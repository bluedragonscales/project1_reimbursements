...
def test_new_reimbursement_happy():
    # If information for the new reimbursement is filled out correctly.
...
def test_new_reimbursement_with_wrong_amount_sad():
    # If a negative number is requested.
